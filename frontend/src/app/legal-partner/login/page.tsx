...
import { Eye, EyeOff, Mail, Lock, Scale, Shield, Gavel, FileCheck, Users, CheckCircle, ArrowLeft } from 'lucide-react'
        ...
        <div className="relative z-10 flex flex-col justify-center">
          <div className="mb-12">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Join India's most secure legal platform for real estate transactions and compliance.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-200">Verified Legal Partners</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Secure access to legal services platform
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8">
            <div className="hidden lg:block mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Sign in to your legal partner account
              </p>
            </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/legal-partner/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                      Forgot password?
                    </Link>
                  </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
              <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                New legal partner?{' '}
                <Link href="/legal-partner/signup" className="text-blue-600 hover:text-blue-700 font-medium">
