...
export default function GroundPartnerLoginPage() {
  ...
  const features = [
    {
      ...
      description: 'Manage property visits with GPS tracking and photo uploads'
    },
    {
      icon: CheckCircle,
      title: 'Task Assignment',
      description: 'Receive and complete verification tasks efficiently'
    },
    {
      icon: Shield,
      title: 'Secure Platform',
      description: 'Bank-grade security for all your professional activities'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex relative">
      ...
      {/* Left Side - Features */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 p-12 pt-20 text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-center">
          <div className="mb-12">
            ...
            <h2 className="text-4xl font-bold mb-4">
              Empowering Field Executives
            </h2>
            <p className="text-xl text-blue-100 leading-relaxed">
              Join India's most trusted real estate platform and grow your career as a verified ground partner.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-200">Active Ground Partners</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8">
            <div className="hidden lg:block mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Sign in to your ground partner account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/ground-partner/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
              <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                New to GharBazaar?{' '}
                <Link href="/ground-partner/signup" className="text-blue-600 hover:text-blue-700 font-medium">
                  Apply as Ground Partner
                </Link>
              </p>
            </div>
          </div>
