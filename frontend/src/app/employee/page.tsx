          ...
          <div className="flex items-center justify-between">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/employee/kyc" className="flex items-center space-x-3 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-8 py-4 rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl border border-white/20">
                  <FileCheck size={24} />
                  <span className="text-lg">Verify KYC</span>
                </Link>
                <Link href="/employee/support" className="flex items-center space-x-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-2xl font-semibold transition-all duration-300 border border-white/20">
            ...
            <div className="hidden lg:flex flex-col items-end space-y-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                <p className="text-white text-sm">You have <span className="font-bold">24 pending tasks</span></p>
                <p className="text-cyan-200 text-xs">and <span className="font-bold text-white">12 active tickets</span> today</p>
              </div>
            </div>
          </div>
        </div>
