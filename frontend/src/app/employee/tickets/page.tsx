...
export default function EmployeeTicketsPage() {
    ...
    const handleAssignTicket = async (ticketId: string) => {
        try {
            ...
            showAlert({
                ...
                message: 'Failed to assign ticket due to a network or server error.',
                type: 'error'
            });
        }
    };
    ...
    const handleCloseTicket = async () => {
        ...
        try {
            ...
            showAlert({
                title: 'Ticket Closed',
                message: 'Ticket closed successfully. Customer will be prompted for feedback.',
                type: 'success'
            });
            ...
            showAlert({
                ...
                message: 'Failed to close ticket. Please try again later.',
                type: 'error'
            });
        }
    };
