...
import { Search, HelpCircle, ChevronDown, ChevronUp, Home, DollarSign, MessageCircle, Shield, Settings as SettingsIcon, Zap, ArrowLeft } from 'lucide-react'
        ...
        <div className="space-y-6">
            ...
            <div>
                <Link
                    ...
                    className="inline-flex items-center space-x-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-4 transition-colors"
                >
                    <ArrowLeft size={20} />
