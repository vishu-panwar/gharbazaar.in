...
export default function AnalyticsPage() {
  ...
  const rentalMetrics = [
    { label: 'Avg. Lease Duration', value: '0 months', icon: Calendar, color: 'purple' },
  ...
  const saleMetrics = [
    ...
    { label: 'Closing Success', value: '0%', icon: CheckCircle, color: 'emerald' }
  ]

  const visitorDemographics: any[] = []
